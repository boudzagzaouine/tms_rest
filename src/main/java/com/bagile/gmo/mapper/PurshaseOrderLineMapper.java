...
public class PurshaseOrderLineMapper {
    public PurshaseOrderLineMapper() {
    }
    ...
    public static RcpPurshaseOrderLine toEntity(PurshaseOrderLine purshaseOrderLine, boolean lazy) {
        ...
        rcpPurshaseOrderLine.setUpdatedBy(purshaseOrderLine.getUpdatedBy());
        rcpPurshaseOrderLine.setCreatedBy(purshaseOrderLine.getCreatedBy());
        rcpPurshaseOrderLine.setRcpPurshaseOrderLineProvisionalCost(purshaseOrderLine.getProvisionalCost());
        rcpPurshaseOrderLine.setRcpPurshaseOrderLineExtraCost(purshaseOrderLine.getExtraCost());
        if (!lazy) {
          //  rcpPurshaseOrderLine.setPdtProductDimension(ProductDimensionMapper.toEntity(purshaseOrderLine.getProductDimension(),true));
            rcpPurshaseOrderLine.setPdtProductPack(ProductPackMapper.toEntity(purshaseOrderLine.getProductPack(), true));
            ...
            rcpPurshaseOrderLine.setPdtProduct(ProductMapper.toEntity(purshaseOrderLine.getProduct(), false));
    ...
    public static PurshaseOrderLine toDto(RcpPurshaseOrderLine rcpPurshaseOrderLine, boolean lazy) {
        ...
        purshaseOrderLine.setUpdatedBy(rcpPurshaseOrderLine.getUpdatedBy());
        purshaseOrderLine.setCreatedBy(rcpPurshaseOrderLine.getCreatedBy());
        purshaseOrderLine.setProvisionalCost(rcpPurshaseOrderLine.getRcpPurshaseOrderLineProvisionalCost());
        purshaseOrderLine.setExtraCost(rcpPurshaseOrderLine.getRcpPurshaseOrderLineExtraCost());
        if (!lazy) {
            purshaseOrderLine.setProductPack(ProductPackMapper.toDto(rcpPurshaseOrderLine.getPdtProductPack(), false));
           // purshaseOrderLine.setProductDimension(ProductDimensionMapper.toDto(rcpPurshaseOrderLine.getPdtProductDimension(),true));
            ...
            purshaseOrderLine.setProduct(ProductMapper.toDto(rcpPurshaseOrderLine.getPdtProduct(), false));
