...
/**
 * StkStockArc generated by hbm2java
 */
@Entity
@Table(name = "stk_stock_arc")
public class StkStockArc implements java.io.Serializable {
    ...
    @SequenceGenerator(name = "seq", sequenceName = "seq_stk_stock_arc", allocationSize = 1)
