...
public class ReceptionArc implements Serializable {

    private static final long serialVersionUID = 7986287792039031933L;
    ...
    private PurshaseOrderArc purshaseOrder;
    ...
    private Set<ReceptionLineArc> receptionLines;
    private Set<ReceptionStockArc> receptionStocks;
    ...
    public PurshaseOrderArc getPurshaseOrder() {
        return purshaseOrder;
    }

    public void setPurshaseOrder(PurshaseOrderArc purshaseOrder) {
    ...
    public Set<ReceptionLineArc> getReceptionLines() {
        return receptionLines;
    }

    public void setReceptionLines(Set<ReceptionLineArc> receptionLines) {
        this.receptionLines = receptionLines;
    }

    public Set<ReceptionStockArc> getReceptionStocks() {
        return receptionStocks;
    }

    public void setReceptionStocks(Set<ReceptionStockArc> receptionStocks) {
    ...
    public boolean equals(Object object) {
        ...
        if (object == null || object.getClass() != getClass()) {
            ...
            ReceptionArc obj = (ReceptionArc) object;
