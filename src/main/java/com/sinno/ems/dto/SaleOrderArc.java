...
public class SaleOrderArc implements Serializable {

    /**
     *
     */
    private static final long serialVersionUID = -6708297412221632950L;
    ...
    private Set<SaleOrderLineArc> lines;
    ...
    public Set<SaleOrderLineArc> getLines() {
        return lines;
    }

    public void setLines(Set<SaleOrderLineArc> lines) {
        this.lines = lines;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (object == null || object.getClass() != getClass()) {
            ...
            SaleOrderArc obj = (SaleOrderArc) object;
