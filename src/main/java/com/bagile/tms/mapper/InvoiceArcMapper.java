...
public class InvoiceArcMapper {
    ...
    public static InvoiceArc toDto(InvInvoiceArc invInvoiceArc, boolean lazy) {
        ...
        if (!lazy) {
            invoiceArc.setContact(com.sinno.ems.mapper.ContactMapper.toDto(invInvoiceArc.getPrmContact(), true));
    ...
    public static InvInvoiceArc toEntity(InvoiceArc invoice, boolean lazy) {
        ...
        if (!lazy) {
            ...
            invInvoiceArc.setPrmContact(com.sinno.ems.mapper.ContactMapper.toEntity(invoice.getContact(), true));
