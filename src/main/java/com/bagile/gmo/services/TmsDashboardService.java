...
public interface TmsDashboardService {
    BigDecimal getVehiclemileage(String vehicleId,String trajetId,String categoryId, String dateDepart, String dateFin);
    BigDecimal getdrivermileage(String driverId,String trajetId,  String dateDepart, String dateFin);
    BigDecimal getVehicleNumberTrajets(String vehicleId,String trajetId,String categoryId, String dateDepart, String dateFin);
    ...
    BigDecimal getAvgDurationOperationTrajetVehicle(String driverId ,String trajetId,String categoryId, String dateDepart, String dateFin);
    BigDecimal getAvgdurationtrajetAttentVehicle(String vehicleId ,String trajetId,String categoryId, String dateDepart, String dateFin);
    BigDecimal getAvgdurationtrajetVehicle(String vehicleId ,String trajetId,String categoryId, String dateDepart, String dateFin);
