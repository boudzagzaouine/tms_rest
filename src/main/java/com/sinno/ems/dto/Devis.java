...
public class Devis {
    ...
    private Set<DevisLine> lines;
    private Address AddressByDeliveryDeliveryAddress;
    private Long cmdDeliveryNumberLine;
    private Long cmdDeliveryNumberLineCmd;
    ...
    public Set<DevisLine> getLines() {
        return lines;
    }

    public void setLines(Set<DevisLine> lines) {
        this.lines = lines;
    }

    public Address getAddressByDeliveryDeliveryAddress() {
        return AddressByDeliveryDeliveryAddress;
    }

    public void setAddressByDeliveryDeliveryAddress(Address addressByDeliveryDeliveryAddress) {
        AddressByDeliveryDeliveryAddress = addressByDeliveryDeliveryAddress;
    }

    public Long getCmdDeliveryNumberLine() {
        return cmdDeliveryNumberLine;
    }

    public void setCmdDeliveryNumberLine(Long cmdDeliveryNumberLine) {
        this.cmdDeliveryNumberLine = cmdDeliveryNumberLine;
    }

    public Long getCmdDeliveryNumberLineCmd() {
        return cmdDeliveryNumberLineCmd;
    }

    public void setCmdDeliveryNumberLineCmd(Long cmdDeliveryNumberLineCmd) {
        this.cmdDeliveryNumberLineCmd = cmdDeliveryNumberLineCmd;
    }
