...
public class SupplierInvoiceLineMapper {
    ...
    static {
        ...
        map.put("description", "invSupplierInvoiceLineDescription");
    ...
    public static InvSupplierInvoiceLine toEntity(SupplierInvoiceLine supplierInvoiceLine, boolean lazy) {
        ...
        invSupplierInvoiceLine.setInvSupplierInvoiceDescription(supplierInvoiceLine.getDescription());
        ...
        invSupplierInvoiceLine.setInvSupplierInvoiceLineVat(supplierInvoiceLine.getVat());
    ...
    public static SupplierInvoiceLine toDto(InvSupplierInvoiceLine invSupplierInvoiceLine, boolean lazy) {
        ...
        supplierInvoiceLine.setDescription(invSupplierInvoiceLine.getInvSupplierInvoiceDescription());
        ...
        supplierInvoiceLine.setVat(invSupplierInvoiceLine.getInvSupplierInvoiceLineVat());
        ...
        if (!lazy) {
            ...
            supplierInvoiceLine.setProduct(ProductMapper.toDto(invSupplierInvoiceLine.getPdtProduct(), false));
