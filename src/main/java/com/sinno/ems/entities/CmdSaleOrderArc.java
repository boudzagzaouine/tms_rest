...
/**
 * CmdSaleOrderArc generated by hbm2java
 */
@Entity
@Table(name = "cmd_saleorder_arc", uniqueConstraints = {
        @UniqueConstraint(columnNames = "cmd_saleordercode")})
public class CmdSaleOrderArc implements Serializable {

    /**
     *
     */
    private static final long serialVersionUID = -228856020252674188L;
    ...
    private Set<CmdSaleOrderLineArc> cmdSaleOrderLines = new HashSet<CmdSaleOrderLineArc>(
            0);

    public CmdSaleOrderArc() {
    }
    ...
    @SequenceGenerator(name = "seq", sequenceName = "seq_cmd_saleorder_arc", allocationSize = 1)
    ...
    @OneToMany(fetch = FetchType.LAZY, mappedBy = "cmdSaleOrder")
    ...
    public Set<CmdSaleOrderLineArc> getCmdSaleOrderLines() {
        return this.cmdSaleOrderLines;
    }

    public void setCmdSaleOrderLines(Set<CmdSaleOrderLineArc> cmdSaleOrderLines) {
