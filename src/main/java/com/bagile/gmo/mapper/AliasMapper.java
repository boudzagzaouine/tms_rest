...
public class AliasMapper {
    ...
    static {
        ...
        map.put("syncWms", "pdtAliasSyncWms");
    }
    ...
    public static PdtAlias toEntity(Alias alias, boolean lazy) {
        ...
        pdtAlias.setUpdatedBy(alias.getUpdatedBy());
        pdtAlias.setCreatedBy(alias.getCreatedBy());
        pdtAlias.setPdtAliasSyncWms(alias.getSyncWms());
        if (!lazy) {
            ...
            pdtAlias.setOwnOwner(OwnerMapper.toEntity(alias.getProduct() != null && alias.getProduct().getOwner() != null ? alias.getProduct().getOwner() : alias.getOwner(), true));
    ...
    public static Alias toDto(PdtAlias pdtAlias, boolean lazy) {
        ...
        alias.setUpdatedBy(pdtAlias.getUpdatedBy());
        alias.setCreatedBy(pdtAlias.getCreatedBy());
        alias.setSyncWms(pdtAlias.getPdtAliasSyncWms());
        if (!lazy) {
