...
//                    ProductMapper.toDtos(pdtProductType.getPdtProductsForPdtProductSubTypeId(), true));
    ...
    public static List<ProductType> toDtos(List<PdtProductType> pdtProductTypes, boolean lazy) {
    ...
    public static List<ProductType> toDtos(Iterable<PdtProductType> pdtProductTypes, boolean lazy) {
        if (null == pdtProductTypes) {
            return null;
        }
        List<ProductType> productTypes = new ArrayList<>();
