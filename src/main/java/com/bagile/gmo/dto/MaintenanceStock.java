...
public class MaintenanceStock  extends EmsDto implements Serializable {
    ...
    private String lot;
    //TODO DATATABLE
    private Maintenance maintenance; //maintenance
    private Container container;
    private Date orderDate;
    private BigDecimal quantityServed;
    private ActionLineMaintenance actionLineMaintenance; //action line
    private Color color;
    private Uom uom;
    private Stock stock;
   ...
   // private ProductDimension productDimension;
    ...
    public ActionLineMaintenance getActionLineMaintenance() {
        return actionLineMaintenance;
    }

    public void setActionLineMaintenance(ActionLineMaintenance actionLineMaintenance) {
