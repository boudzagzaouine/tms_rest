...
public class CompanyMapper {
    ...
    static {
        ...
        map.put("vatNumber", "cmdCompanyVatNumber");
    }
    ...
    public static Company toDto(CmdCompany cmdCompany, boolean lazy) {
        ...
        company.setVatNumber(cmdCompany.getCmdCompanyVatNumber());
        if (!lazy) {
    ...
    public static CmdCompany toEntity(Company company, boolean lazy) {
        ...
        cmdCompany.setCmdCompanyVatNumber(company.getVatNumber());
        if (!lazy) {
            //cmdCompany.setCmdAccounts(AccountMapper.toEntities(company.getAccounts(), true));
