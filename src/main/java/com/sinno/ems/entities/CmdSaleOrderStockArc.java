...
/**
 * CmdSaleOrderstockArc generated by hbm2java
 */
@Entity
@Table(name = "cmd_saleorderstock_arc")
public class CmdSaleOrderStockArc implements Serializable {

    /**
     *
     */
    private static final long serialVersionUID = -561284304615195924L;

    private long cmdSaleOrderStockId;
    private CmdDeliveryArc cmdDelivery;

    private CmdDeliveryLineArc cmdDeliveryLine;
    ...
    @Size(max = 255)
    private String cmdSaleOrderStockTransportContainerNo;
    ...
    @SequenceGenerator(name = "seq", sequenceName = "seq_cmd_saleorderstock_arc", allocationSize = 1)
    ...
    public CmdDeliveryLineArc getCmdDeliveryLine() {
        return this.cmdDeliveryLine;
    }

    public void setCmdDeliveryLine(CmdDeliveryLineArc cmdSaleOrderLine) {
    ...
    @Column(name = "cmd_saleorderstocktransportcontainerno", length = 50)
    public String getCmdSaleOrderStockTransportContainerNo() {
        return this.cmdSaleOrderStockTransportContainerNo;
    }

    public void setCmdSaleOrderStockTransportContainerNo(
            String cmdSaleOrderStockTransportContainerNo) {
        this.cmdSaleOrderStockTransportContainerNo = cmdSaleOrderStockTransportContainerNo;
    }
