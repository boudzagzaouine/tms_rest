...
public class AgencyController {
    ...
    @ResponseBody
    public List<Agency> getAgencys() {return agencyService.findAll();}
   //@PreAuthorize("hasAnyRole('BADGETYPE_VIEW')")
    @RequestMapping(method = RequestMethod.GET, value = "/listPage")
    @ResponseBody
    public List<Agency> getAgency(@RequestParam int page, @RequestParam int size) {
    ...
    @ResponseBody
    public Agency add(@RequestBody Agency agency ){return agencyService.save(agency);}
    ...
    public void deleteAll(@RequestParam(value = "ids") Long[] ids) {
        agencyService.deleteAll (Arrays.asList(ids));
    }
}