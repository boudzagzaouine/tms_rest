...
public class OrgOrganisation extends EmsEntity{
  ...
  //  private PrmEan prmEan;
    private OwnOwner ownOwner;
    private String orgOrganisationWebSite;
    private String orgOrganisationGeneraleCondition;
    private String orgOrganisationCommonIdentifierCompany;
    private String orgOrganisationTaxpayerIdentification;
    private String orgOrganisationProfessionalTax;
 ...
 /*   @OneToOne(fetch = FetchType.LAZY)
    @PrimaryKeyJoinColumn(name = "org_organisationeanid")
    public PrmEan getPrmEan() {
        return prmEan;
    }

    public void setPrmEan(PrmEan prmEan) {
        this.prmEan = prmEan;
    }
*/
    ...
    @Column(name = "org_organisationcommonidentifiercompany")

    public String getOrgOrganisationCommonIdentifierCompany() {
        return orgOrganisationCommonIdentifierCompany;
    }

    public void setOrgOrganisationCommonIdentifierCompany(String orgOrganisationCommonIdentifierCompany) {
        this.orgOrganisationCommonIdentifierCompany = orgOrganisationCommonIdentifierCompany;
    }
    @Column(name = "org_organisationtaxpayeridentification")

    public String getOrgOrganisationTaxpayerIdentification() {
        return orgOrganisationTaxpayerIdentification;
    }

    public void setOrgOrganisationTaxpayerIdentification(String orgOrganisationTaxpayerIdentification) {
        this.orgOrganisationTaxpayerIdentification = orgOrganisationTaxpayerIdentification;
    }
    @Column(name = "org_organisationtaxprofessionalTax")

    public String getOrgOrganisationProfessionalTax() {
        return orgOrganisationProfessionalTax;
    }

    public void setOrgOrganisationProfessionalTax(String orgOrganisationProfessionalTax) {
        this.orgOrganisationProfessionalTax = orgOrganisationProfessionalTax;
    }
}
