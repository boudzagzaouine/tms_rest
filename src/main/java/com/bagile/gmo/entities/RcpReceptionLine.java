...
public class RcpReceptionLine extends EmsEntity implements java.io.Serializable {
  ...
  //  @NotNull
   ...
   // private PdtProductDimension pdtProductDimension;
    ...
    private PdtProductPack pdtProductPackReceived;
    private BigDecimal rcpReceptionLineExtraCost;
...
*/
  ...
  /*  @ManyToOne(fetch = FetchType.LAZY)
    ...
    */
    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(name = "rcp_receptionlinepackid")
    ...
    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(name = "rcp_receptionlinepackreceivedid")
    public PdtProductPack getPdtProductPackReceived() {
        return pdtProductPackReceived;
    }

    public void setPdtProductPackReceived(PdtProductPack pdtProductPackReceived) {
        this.pdtProductPackReceived = pdtProductPackReceived;
    }
    @Column(name = "rcp_receptionlineprovisionalcost")
    public BigDecimal getRcpReceptionLineProvisionalCost() {
        return rcpReceptionLineProvisionalCost;
    }

    public void setRcpReceptionLineProvisionalCost(BigDecimal rcpReceptionLineProvisionalCost) {
        this.rcpReceptionLineProvisionalCost = rcpReceptionLineProvisionalCost;
    }
    @Column(name = "rcp_receptionlineextracost")
    public BigDecimal getRcpReceptionLineExtraCost() {
        return rcpReceptionLineExtraCost;
    }

    public void setRcpReceptionLineExtraCost(BigDecimal rcpReceptionLineExtraCost) {
        this.rcpReceptionLineExtraCost = rcpReceptionLineExtraCost;
    }
}
