...
public class CmdDeliveryLine {
    ...
    private CmdPreparationLine cmdPreparationLine;
    ...
    public CmdPreparationLine getCmdPreparationLine() {
        return cmdPreparationLine;
    }

    public void setCmdPreparationLine(CmdPreparationLine cmdPreparationLine) {
        this.cmdPreparationLine = cmdPreparationLine;
    }
    ...
    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(name = "cmd_deliverylineproductdimensionid")
