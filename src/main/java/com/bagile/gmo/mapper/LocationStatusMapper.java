...
import com.bagile.gmo.dto.LocationStatus;
import com.bagile.gmo.entities.PrmLocationStatus;
...
public class LocationStatusMapper {
    ...
    public static LocationStatus toDto(PrmLocationStatus prmLocationStatus, boolean lazy) {
        ...
        locationStatus.setUpdatedBy(prmLocationStatus.getUpdatedBy());
        locationStatus.setCreatedBy(prmLocationStatus.getCreatedBy());
        if (!lazy) {
