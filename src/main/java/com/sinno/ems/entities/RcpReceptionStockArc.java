...
/**
 * RcpReceptionstockArc generated by hbm2java
 */
@Entity
@Table(name = "rcp_receptionstock_arc")
public class RcpReceptionStockArc implements java.io.Serializable {
    ...
    @NotNull
    private RcpReceptionLineArc rcpReceptionLine;
    ...
    @SequenceGenerator(name = "seq", sequenceName = "seq_rcp_receptionstock_arc", allocationSize = 1)
    ...
    public RcpReceptionLineArc getRcpReceptionLine() {
        return this.rcpReceptionLine;
    }

    public void setRcpReceptionLine(RcpReceptionLineArc rcpReceptionLine) {
