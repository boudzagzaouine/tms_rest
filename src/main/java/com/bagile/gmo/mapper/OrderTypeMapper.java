...
public class OrderTypeMapper {
    ...
    public static PrmOrderType toEntity(OrderType orderType, boolean lazy) {
        ...
        prmOrderType.setUpdatedBy(orderType.getUpdatedBy());
        prmOrderType.setCreatedBy(orderType.getCreatedBy());
    ...
    public static OrderType toDto(PrmOrderType prmOrderType, boolean lazy) {
        ...
        orderType.setUpdatedBy(prmOrderType.getUpdatedBy());
        orderType.setCreatedBy(prmOrderType.getCreatedBy());
