...
public interface ProductRepository extends JpaRepository<PdtProduct, Long>,
	...
	@Query(value = "select COALESCE(sum(stk_stockquantity),0) from schema_tmsvoieexpress.stk_stock where stk_stockproductid=:id  and stk_stockactive=true", nativeQuery = true)
