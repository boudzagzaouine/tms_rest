...
public class OrderTransportInfoController {
    ...
    @ResponseBody
    public OrderTransportInfo add(@RequestBody OrderTransportInfo orderDeliveryType) {
        return orderTransportInfoService.save(orderDeliveryType);
    }

    @RequestMapping(value = "/save", method = RequestMethod.PUT, produces = MediaType.APPLICATION_JSON_VALUE)
    @ResponseBody
    public OrderTransportInfo set(@RequestBody OrderTransportInfo orderDeliveryType) {
        return orderTransportInfoService.save(orderDeliveryType);
    }
