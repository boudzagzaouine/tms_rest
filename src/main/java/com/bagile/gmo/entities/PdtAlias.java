...
public class PdtAlias extends EmsEntity implements java.io.Serializable {
    ...
    private Boolean  pdtAliasSyncWms;
    ...
    @JoinColumn(name = "pdt_aliasownerid")
    ...
    @Column(name = "pdt_aliassyncwms")
    public Boolean getPdtAliasSyncWms() {
        return pdtAliasSyncWms;
    }

    public void setPdtAliasSyncWms(Boolean pdtAliasSyncWms) {
        this.pdtAliasSyncWms = pdtAliasSyncWms;
    }
}
