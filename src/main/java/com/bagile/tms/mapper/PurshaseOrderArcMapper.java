...
public class PurshaseOrderArcMapper {
    private PurshaseOrderArcMapper() {
    }
    ...
    public static RcpPurshaseOrderArc toEntity(PurshaseOrderArc purshaseOrder, boolean lazy) {
        if (null == purshaseOrder) {
            return null;
        }
        RcpPurshaseOrderArc rcpPurshaseOrder = new RcpPurshaseOrderArc();
        rcpPurshaseOrder.setRcpPurshaseOrderId(purshaseOrder.getId());
        rcpPurshaseOrder.setRcpPurshaseOrderCode(purshaseOrder.getCode());
        ...
        if (!lazy) {
            ...
            rcpPurshaseOrder.setWrhWarehouseSource(WarehouseMapper.toEntity(purshaseOrder.getWarehouse(), true));
            ...
            rcpPurshaseOrder.setRcpPurshaseOrderLines(PurshaseOrderLineArcMapper.toEntities(purshaseOrder.getPurshaseOrderLines(), false));
...
//            rcpPurshaseOrder.setRcpReceptionArcs(ReceptionArcMapper.toEntities(purshaseOrder.getReceptionArcs(), true));
    ...
    public static void oneToMany(RcpPurshaseOrderArc purshaseOrder) {
    ...
    public static PurshaseOrderArc toDto(RcpPurshaseOrderArc rcpPurshaseOrder, boolean lazy) {
        if (null == rcpPurshaseOrder) {
            return null;
        }
        PurshaseOrderArc purshaseOrder = new PurshaseOrderArc();
        ...
        if (!lazy) {
            ...
            purshaseOrder.setWarehouse(WarehouseMapper.toDto(rcpPurshaseOrder.getWrhWarehouseSource(), true));
            ...
            purshaseOrder.setPurshaseOrderLines(PurshaseOrderLineArcMapper.toDtos(rcpPurshaseOrder.getRcpPurshaseOrderLines(), false));
...
//            purshaseOrder.setReceptionArcs(ReceptionArcMapper.toDtos(rcpPurshaseOrder.getRcpReceptionArcs(), true));
    ...
    public static List<PurshaseOrderArc> toDtos(List<RcpPurshaseOrderArc> rcpPurshaseOrders, boolean lazy) {
        if (null == rcpPurshaseOrders) {
            return null;
        }
        List<PurshaseOrderArc> purshaseOrders = new ArrayList<>();
        for (RcpPurshaseOrderArc rcpPurshaseOrder : rcpPurshaseOrders) {
            purshaseOrders.add(toDto(rcpPurshaseOrder, lazy));
        }
        return purshaseOrders;
    }

    public static List<PurshaseOrderArc> toDtos(Iterable<RcpPurshaseOrderArc> rcpPurshaseOrders, boolean lazy) {
        if (null == rcpPurshaseOrders) {
            return null;
        }
        List<PurshaseOrderArc> purshaseOrders = new ArrayList<>();
    ...
    public static Set<RcpPurshaseOrderArc> toEntities(Set<PurshaseOrderArc> purshaseOrders, boolean lazy) {
        if (null == purshaseOrders) {
            return null;
        }
        Set<RcpPurshaseOrderArc> rcpPurshaseOrders = new HashSet<>();
        for (PurshaseOrderArc rurshaseOrder : purshaseOrders) {
            rcpPurshaseOrders.add(toEntity(rurshaseOrder, lazy));
        }
        return rcpPurshaseOrders;
    }

    public static Set<PurshaseOrderArc> toDtos(Set<RcpPurshaseOrderArc> rcpPurshaseOrders, boolean lazy) {
        if (null == rcpPurshaseOrders) {
            return null;
        }
        Set<PurshaseOrderArc> purshaseOrders = new HashSet<>();
        for (RcpPurshaseOrderArc rcpPurshaseOrder : rcpPurshaseOrders) {
            purshaseOrders.add(toDto(rcpPurshaseOrder, lazy));
        }
        return purshaseOrders;
