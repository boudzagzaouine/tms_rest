...
@Entity
@Table(name = "stk_container_arc")
public class StkContainerArc implements java.io.Serializable {
    ...
    public StkContainerArc() {
    }

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "seq")
    @SequenceGenerator(name = "seq", sequenceName = "seq_stk_container_arc", allocationSize = 1)
    ...
    public boolean equals(Object object) {
        ...
        if (object == null || object.getClass() != getClass()) {
            ...
            StkContainerArc obj = (StkContainerArc) object;
