...
public interface SaleOrderRepository extends JpaRepository<CmdSaleOrder, Long>,
	...
	@Query(value="select nextval('schema_tmsvoieexpress.seq_sale_order_code')",nativeQuery = true)
	public List<BigInteger> getNextVal();
	@Query(value = "select nextval('schema_tmsvoieexpress.seq_code_transfert')",nativeQuery = true)
